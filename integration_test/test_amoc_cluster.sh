...
amoc_eval amoc-master "amoc_code_server:list_scenario_modules()." | contain dummy_scenario
amoc_eval amoc-master "amoc_code_server:list_configurable_modules()." | contain dummy_helper
